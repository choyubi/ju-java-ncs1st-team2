...
public class WebHelper {
    ...
    /** JSP의 resopnse 내장 객체 */
    // --> import javax.servlet.http.HttpServletRestonse;
     ...
     * JSP의 내장객체는 JSP페이지에서만 생성되기 때문에,
     * 일반 Java 클래스에서 접근하기 위해서는 JSP페이지에서 전달받아야 한다.
     */
	...
	public void setCookie(String key, String value, int timeout){
	    ...
	    /** 유효시간 설정 */
	    // 시간값이 0보다 작은 경우 이 메서드를 설정하지 않도록 한다. (브라우저를 닫으면 삭제)
	...
	/**
	 * 현재 프로젝트의 최상위 경ㅇ로값을 "/프로젝트명" 형식으로 리턴한다.
	 * @return
	 */
	...
	/**
	 * 결과 메시지를 JSON으로 출력한다.
	 * JSON Api 에서 web.redirect() 기능을 대체할 용도.
	 * @param - JSON에 포함할 메시지 내용
	 */
