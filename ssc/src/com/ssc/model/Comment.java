...
public class Comment {
    ...
    public int getHoogiDocumentId() {
        return hoogiDocumentId;
    }
    public void setHoogiDocumentId(int hoogiDocumentId) {
        this.hoogiDocumentId = hoogiDocumentId;
    }
	...
	return "Comment [id=" + id + ", writerName=" + writerName + ", writerPw=" + writerPw + ", email=" + email
		...
		+ ipAddress + ", hoogiDocumentId=" + hoogiDocumentId + ", userId=" + userId + "]";
    }
