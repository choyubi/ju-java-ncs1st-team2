				...
				<div class="row" id="c">
					...
					<div class="clearfix">
						<div class="pull-right">
							...
							<a href="${pageContext.request.contextPath}/zone/zone_edit.do?zone_num=${readZone.num}"
								class="btn btn-warning">수정하기</a> 
							<a href="${pageContext.request.contextPath}/zone/zone_delete.do?zone_num=${readZone.num}"
