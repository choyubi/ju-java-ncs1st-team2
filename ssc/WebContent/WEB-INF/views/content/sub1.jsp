					...
					<div id="sscar1" class="content" style="display: block">
						...
						<ul id="gallery">
							<li><span class="thumb"><img src="img/thum-01.png"
									alt="회원가입" /></span> <span class="text"><strong>회원가입</strong><br />
									카셰어링은 신뢰를 기반으로 한 회원제 서비스 입니다.<br /> 회원가입 후 SSC회원이 되시면 이용이
									가능합니다.</span></li>
							...
							<li><span class="thumb"><img src="img/thum-03.png"
									...
									시간에 예약한 존에 방문하여 차량 이용을 할 수 있습니다.</span></li>
							<li><span class="thumb"><img src="img/thum-04.png"
									alt="차량반납" /></span> <span class="text"><strong>차량반납</strong><br />반납
									시간에 맞추어 차량을 반납 장소에 주차하신 후 모바일앱 스마트키 및 회원카드로 차량 문을 잠가 주세요.<br />
									제자리에 정상 반납 처리되면 휴대폰으로 확인 메시지가 발송됩니다.</span></li>
							<li><span class="thumb"><img src="img/thum-05.png"
									alt="요금결제" /></span> <span class="text"><strong>요금결제</strong><br />차량
									이용에 따른 요금은 대여료와 주행요금으로 구분되며,가입시 등록한 결제카드로 청구됩니다.<br /> 결제가 완료되지
									않으면 차량 사용에 제한이 있을 수 있으니, 미리 결제카드의 유효여부를 확인해 주세요.</span></li>
						</ul>
						<!-- gallery 영역 끝 -->
					</div>
					<!-- // 서비스 안내 -> 이용방법 테이블 끝-->
