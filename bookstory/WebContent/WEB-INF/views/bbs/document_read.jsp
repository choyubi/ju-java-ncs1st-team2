				...
				<div class="row" id="c">
					...
					<div class="alert alert-info">
						<h3 style="margin: 0">
							${readDocument.subject}<br /> <small>
								${readDocument.writerName} <a
								href="mailto:${readDocument.email}"> <i
									class="glyphicon glyphicon-envelope"></i></a> / 조회수 :
								${readDocument.hit} / 작성일시 : ${readDocument.regDate}
							</small>
						</h3>
					</div>
					...
					<div class="clearfix">
						<div class="pull-right">
							...
							<a
								href="${pageContext.request.contextPath}/bbs/document_edit.do?category=${category}&
			document_id=${readDocument.id}"
								class="btn btn-warning">수정하기</a> <a
								href="${pageContext.request.contextPath}/bbs/document_delete.do?category=${category}&
			document_id=${readDocument.id}"
